...
├── database.py            # Работа с базой данных PostgreSQL/Supabase
...
| 3m | 3 месяца (90 дней) | 500 ₽ |
| 6m | 6 месяцев (180 дней) | 900 ₽ |
| 12m | 1 год (365 дней) | 1550 ₽ |
...
**database.py** - Работает с PostgreSQL/Supabase базой данных:
