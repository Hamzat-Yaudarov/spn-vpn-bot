...
```sh
apksigner verify --verbose --print-certs app/build/outputs/apk/release/WayVPN-1.1.1-universal-release.apk
shasum -a 256 app/build/outputs/apk/release/WayVPN-1.1.1-universal-release.apk
```
