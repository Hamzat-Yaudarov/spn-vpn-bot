...
//    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val expiry = MmkvManager.decodeSettingsLong(WayRuntimePolicy.PROFILE_EXPIRY_SETTING, 0L)
        if (!WayRuntimePolicy.isProfileUsable(expiry)) {
            LogUtil.w(AppConfig.TAG, "StartCore-VPN: Stored profile is expired or unavailable")
            stopSelf()
