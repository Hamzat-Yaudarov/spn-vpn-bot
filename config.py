...
ANDROID_LATEST_VERSION_CODE = int(os.getenv("ANDROID_LATEST_VERSION_CODE", "8"))
ANDROID_LATEST_VERSION_NAME = os.getenv("ANDROID_LATEST_VERSION_NAME", "1.1.6")
ANDROID_MIN_SUPPORTED_VERSION_CODE = int(os.getenv("ANDROID_MIN_SUPPORTED_VERSION_CODE", "1"))
ANDROID_APK_URL = os.getenv("ANDROID_APK_URL", f"{PUBLIC_SITE_URL}/downloads/WayVPN-1.1.6-universal-release.apk")
ANDROID_APK_SHA256 = os.getenv("ANDROID_APK_SHA256", "e2581d736399aa39d2062665afab4802113836e72c8ca010060624d099f2acde")
