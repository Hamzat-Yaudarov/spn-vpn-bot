...
ANDROID_LATEST_VERSION_CODE = int(os.getenv("ANDROID_LATEST_VERSION_CODE", "3"))
ANDROID_LATEST_VERSION_NAME = os.getenv("ANDROID_LATEST_VERSION_NAME", "1.1.1")
ANDROID_MIN_SUPPORTED_VERSION_CODE = int(os.getenv("ANDROID_MIN_SUPPORTED_VERSION_CODE", "1"))
ANDROID_APK_URL = os.getenv("ANDROID_APK_URL", f"{PUBLIC_SITE_URL}/downloads/WayVPN-1.1.1-universal-release.apk")
ANDROID_APK_SHA256 = os.getenv("ANDROID_APK_SHA256", "5cb3eb02798694735bae776f186ecda3068fe77bc9ef787da844bfc3aeb219d4")
