...
ANDROID_LATEST_VERSION_CODE = int(os.getenv("ANDROID_LATEST_VERSION_CODE", "7"))
ANDROID_LATEST_VERSION_NAME = os.getenv("ANDROID_LATEST_VERSION_NAME", "1.1.5")
ANDROID_MIN_SUPPORTED_VERSION_CODE = int(os.getenv("ANDROID_MIN_SUPPORTED_VERSION_CODE", "1"))
ANDROID_APK_URL = os.getenv("ANDROID_APK_URL", f"{PUBLIC_SITE_URL}/downloads/WayVPN-1.1.5-universal-release.apk")
ANDROID_APK_SHA256 = os.getenv("ANDROID_APK_SHA256", "97532ad4be5960c433f730db47f95dc484dfd1cd1471cd75ede6a65ff32bdd0c")
