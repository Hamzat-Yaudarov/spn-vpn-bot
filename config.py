...
ANDROID_LATEST_VERSION_CODE = int(os.getenv("ANDROID_LATEST_VERSION_CODE", "11"))
ANDROID_LATEST_VERSION_NAME = os.getenv("ANDROID_LATEST_VERSION_NAME", "1.1.9")
ANDROID_MIN_SUPPORTED_VERSION_CODE = int(os.getenv("ANDROID_MIN_SUPPORTED_VERSION_CODE", "1"))
ANDROID_APK_URL = os.getenv("ANDROID_APK_URL", f"{PUBLIC_SITE_URL}/downloads/WayVPN-1.1.9-universal-release.apk")
ANDROID_APK_SHA256 = os.getenv("ANDROID_APK_SHA256", "41e64aa4ec3aa9f5e97f82a857307bb42ebe94cc62c89e9b6499c454d226988b")
